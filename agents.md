...
- **2026-09-17 起**：可跑 `python purge_expired.py --dry-run`（30 天保留期下最早到期的是 `w433`）
  後續陸續到期：2026-09 月 95 筆、10 月 273 筆、11 月 35 筆
- 爬蟲上架節奏：約每 8～11 天一次（實績：7/24、8/2、8/10-11、8/21、8/28）
